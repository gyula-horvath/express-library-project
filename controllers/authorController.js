...
// Desplay detaile page for a specific Author.
...
exports.author_create_post = [
    ...
    (req, res, next) => {
        ...
        if (!errors.isEmpty()) {
            ...
            // Dtat from form is valid.

            // Create an Author object with escaped and trimmed datat.
            ...
            author.save(function (err) {
                ...
                //Susccessful - redirect to new author record.
