...
exports.bookinstance_list = function(req, res, next) {
    ...
    BookInstance.find()
        .populate('book')
        .exec(function (err, list_boolinstances) {
            if (err) { return next(err); }
            //Successful, so render
            res.render('bookinstance_list', { title: 'Book Instance List', bookinstance_list: list_boolinstances });
        });
    ...
    async.parallel({
        ...
        // Success
            ...
            BookInstance.findByIdAndRemove(req.body.bookinstanceid, function deleteBookInstance(err) {
                ...
                req.flash('success', 'Book Instance deleted')
                res.redirect('/catalog/bookinstances')
            })
        }
    })
